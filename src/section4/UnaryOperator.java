...
public class UnaryOperator {
  ...
  public static void main(String[] args) {
    ...
    while (--b2 > 0) { // Use a prefix decrement
      loopiterations++;
    }
    System.out.println(
        "Prefix decrement operator used, loopiterations = " + loopiterations + ", b = " + b2);

    // Reset values, all things equal except the type of increment operator
    b2 = 5;
    loopiterations = 0;
    while (b2-- > 0) { // Use a postfix decrement
      loopiterations++;
    }
    System.out.println(
        "Postfix decrement operator used, loopiterations = " + loopiterations + ", b = " + b2);
